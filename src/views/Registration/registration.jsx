...
const RegistrationPage = () => {
  return (
    <div className="registrationPage">
      ...
      <div className="note">
        <p>Department of CSE Organizing Two days National Conference on “Recent Advancements in Computing, Communication & Societal Applications” (NASA’23) 19/04/2023 & 20/04/2023. </p> <br/><br/>
